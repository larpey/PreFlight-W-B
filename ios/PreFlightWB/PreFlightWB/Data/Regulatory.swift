...
struct RegulatoryReference: Sendable {
    let title: String
    let text: String
    let url: String
}
...
enum Regulatory {
    ...
    IMPORTANT: This calculator is a supplemental planning tool only. It does NOT replace the official Pilot's Operating Handbook (POH) or aircraft-specific weight and balance records.
    ...
    static let references: [String: RegulatoryReference] = [
        "FAR 91.103": RegulatoryReference(
        ...
        "AC 120-27F": RegulatoryReference(
